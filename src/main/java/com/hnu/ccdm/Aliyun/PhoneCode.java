...
//
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("数学学习软件");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_174272420");
    ...
    public static String sendSMS(String number)    //给number 发短信，返回验证码
    {
        PhoneCode phoneCode = new PhoneCode();
        return phoneCode.getPhonemsg(number);
    }
}